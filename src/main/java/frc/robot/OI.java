...
public class OI {
  ...
  // public static Button LiftDown = new JoystickButton(joyControl, 4);
  // public static Button LiftUp = new JoystickButton(joyControl, 2);

  public static Button RightForward = new JoystickButton(joyControl, 5);
  public static Button LeftForward = new JoystickButton(joyControl, 6);
