...
public class MoveArm extends Command {
  ...
  protected void execute() {
    ...
    if(OI.joyControl.getRawButton(1)){
      Robot.arm.setArmPosition(-1100);
    } else if(OI.joyControl.getRawButton(3)){
      Robot.arm.setArmPosition(-2030);
    } else if(OI.joyControl.getRawButton(4)){
      Robot.arm.setArmPosition(-3200);
    }
