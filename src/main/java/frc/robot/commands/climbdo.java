...
public class climbdo extends Command {
  ...
  protected void initialize() {
    // Robot.climby.climb1.setInverted(true);
  ...
  protected void execute() {
    ...
    //if(Constants.isClimbing)  {
      ...
      while(OI.joyControl.getRawButton(8)) {
        Robot.climby.lift1Encoder((.7 - (Robot.climby.getDifference()/5000)) * -1, 26000);
        Robot.climby.lift2Encoder((.7 + (Robot.climby.getDifference()/5000)) * -1, 26000);
      }
    }
  //}
